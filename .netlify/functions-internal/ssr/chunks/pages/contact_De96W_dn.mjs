import { c as createAstro, d as createComponent, r as renderTemplate, m as maybeRenderHead, e as addAttribute, f as renderSlot, g as renderComponent, h as renderHead } from '../astro_BUxd-_F3.mjs';
import 'kleur/colors';
...
const $$DesktopToggleMenu = createComponent(async ($$result, $$props, $$slots) => {
...
const $$MobileToggleMenu = createComponent(async ($$result, $$props, $$slots) => {
...
const $$Contact = createComponent(async ($$result, $$props, $$slots) => {
  ...
  assert$1(metadataList.length === 1);
