(function ($) {
 ...
 new Swiper(".car-slider", {
  ...
  new Swiper(".h3-feedback-client-slider", {
    spaceBetween: 24,
    slidesPerView: 4,
    freeMode: true,
    watchSlidesProgress: true,
 ...
 new Swiper(".h4-hero-slider", {
  ...
  $(".eq-hero-slider").siblings(".slide-end-index").text(eqSlideIndex);

  //cycle feedback slider
  ...
  $(window).on("load", function () {
    ...
    $(".h4-filter-btn-group").on("click", "button", function () {
      var filterValue = $(this).attr("data-filter");
      $filter_grid_2.isotope({ filter: filterValue });
    ...
    $(".bs-filter-btn-group").on("click", "button", function () {
      var filterValue = $(this).attr("data-filter");
      $filter_grid_3.isotope({ filter: filterValue });
    ...
    $(".listing-ft-controls").on("click", "button", function () {
      var filterValue = $(this).attr("data-filter");
      filter_grid_4.isotope({ filter: filterValue });
