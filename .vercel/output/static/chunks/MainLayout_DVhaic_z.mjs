import { c as createComponent, r as renderTemplate, m as maybeRenderHead, a as addAttribute, s as spreadAttributes, e as createAstro, f as renderSlot, d as renderComponent, b as renderHead } from './astro/server_ExnHLPWg.mjs';
import { A as AstroError, E as ExpectedImageOptions, g as ExpectedImage, r as resolveSrc, i as isRemoteImage, F as FailedToFetchRemoteImageDimensions, h as isESMImportedImage, j as isLocalService, D as DEFAULT_HASH_PROPS, k as InvalidImageService, l as ImageMissingAlt } from './astro/assets-service_VjHDanqS.mjs';
import 'html-escaper';
import 'clsx';
...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      './astro/assets-service_VjHDanqS.mjs'
    ).then(n => n.s).catch((e) => {
...
}, "/Users/a61403/Desktop/car_rental/node_modules/astro/components/Image.astro", void 0);
...
}, "/Users/a61403/Desktop/car_rental/node_modules/astro/components/Picture.astro", void 0);

const $$Astro$2 = createAstro();
const $$DesktopToggleMenu = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$2, $$props, $$slots);
  Astro2.self = $$DesktopToggleMenu;
  const {
    label = "Toggle Menu",
    class: className = "toggle-menu-button ofcanvus-toggle d-none d-lg-flex"
  } = Astro2.props;
  return renderTemplate`${maybeRenderHead()}<button${addAttribute(className, "class")}${addAttribute(label, "aria-label")} data-aw-toggle-menu> <span class="sr-only">${label}</span> ${renderSlot($$result, $$slots["default"], renderTemplate` <span aria-hidden="true" class="toggle-menu-line"></span> <span aria-hidden="true" class="toggle-menu-line"></span> <span aria-hidden="true" class="toggle-menu-line"></span> `)} </button>`;
}, "/Users/a61403/Desktop/car_rental/src/components/DesktopToggleMenu.astro", void 0);

const $$Astro$1 = createAstro();
const $$MobileToggleMenu = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$1, $$props, $$slots);
  Astro2.self = $$MobileToggleMenu;
  const {
    label = "Toggle Menu",
    class: className = "toggle-menu-button mobile-menu-toggle d-lg-none"
  } = Astro2.props;
  return renderTemplate`${maybeRenderHead()}<button${addAttribute(className, "class")}${addAttribute(label, "aria-label")} data-aw-toggle-menu> <span class="sr-only">${label}</span> ${renderSlot($$result, $$slots["default"], renderTemplate` <span aria-hidden="true" class="toggle-menu-line"></span> <span aria-hidden="true" class="toggle-menu-line"></span> <span aria-hidden="true" class="toggle-menu-line"></span> `)} </button>`;
}, "/Users/a61403/Desktop/car_rental/src/components/MobileToggleMenu.astro", void 0);
